...
import com.example.demo.product.model.request.RequestLink;
import com.example.demo.product.model.request.SubscribeBilling;
import com.example.demo.product.model.request.SubscribeBillingReserve;
import com.example.demo.product.model.request.Token;
import com.example.demo.product.model.request.User;
import com.example.demo.product.model.response.ResToken;
...
//     private final String URL_REMOTE_FORM = BASE_URL + "app/rest/remote_form.json";
    ...
    private String token = "737f4d6a8b84a03182b8ae4d3f26171c9eb06a318e570b96c2c7b3d670041481";
...
//        if(subscribeBilling.price <= 0) throw new Exception("price 금액을 설정을 해주세요.");
	...
	public HttpResponse remote_form(RemoteForm form) {
