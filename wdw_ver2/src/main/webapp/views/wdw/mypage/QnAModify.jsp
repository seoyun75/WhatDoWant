       ...
       <div class="mp_nav">
        ...
        <div id="contents">
            <div class="mp_qna">
                ...
                <form action="QnAModreg?si_no=${data.si_no}" method="post">
                    <div>
                        <div>
                            <div>제목</div>
                            <input type="text" name="si_title" value="${data.si_title }">
                            <div>
                        ...
                        <div>
                            <div>내용</div>
                            <textarea name="si_content" id="" cols="120" rows="100" var>${data.si_content.replace("<br/>","") }</textarea>
                        </div>
                        <div>
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <input class="btn btn-primary" type="submit" value="수정" class="wdw_btn">
