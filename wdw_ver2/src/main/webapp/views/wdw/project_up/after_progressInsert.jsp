...
<div id="funding_wrap">
            ...
            <div id = "regist">
                <h4>진행과정 등록</h4>
                <form action="after_progressInsertReg" method="post" enctype="multipart/form-data">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <input type="text" name="project_board_title" id="name" class="inp_txt" maxlength="15">
                            </td>
                        </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <div class="textarea_box">
                                        <textarea name="project_board_content" id="textarea" rows="75" cols="10"></textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="mtit">첨부파일</div>
                                    	<input type="file" id="file_up" name="progressFile">
                                    	<input type="hidden" name="project_board_pro_no" value="${data.pro_code}" /> 
                ...
                <div class="btn_group re_text_center">
                    <input class="button_last" type="button" value="목록으로" >        <!-- 해당 카테고리 페이지 -->
                    <!--  -->
                    <input class="button_last" type="submit" value="등록" >     <!--등록 페이지-->
                </div>
                </form>
            </div>	
        </div>
