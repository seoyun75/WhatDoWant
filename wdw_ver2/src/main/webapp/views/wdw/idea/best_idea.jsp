			...
			<div id="idea_wrapper">
				<div id="banner_wrap">
					<div class="banner_img">
						<p class = "banner_title">베스트 아이디어</p>
				...
				<div id = "idea_wrap">
					...
					<div class="idea_container" id="idea_container">
                        <h4 class = "sub_strapline">베스트 게시판</h4>
                        ...
                        <div class="bestofbest">
                        	<a href="idea_detail"><img src="${path }/resources/img/idea/img5.jpg" alt="베스트">
                        		<div>베스트베스트베스트<br>베스트베스트베스트베스트베스트베스트</div>
                        	</a>
                            ...
                            <div class="idea_tab_content">
                                <div class="idea_tab_cont on">
                                    <div class="idea_inner">
                                        <h4 class="hidden">베스트</h4>
                                        <div class="idea_list_type01">
                                            <ul>
                                                <li>
                                                    <a href="idea_detail" target="_self" class="idea_inner_box" onclick="">
                                                        <span class="idea_thumb">
                                                            <img src="${path }/resources/img/idea/img5.jpg" alt="베스트">
                                                        </span>
                                                        <span class="idea_list_info">
                                                            <em class="idea_title">베스트베스트베스트</em>
                                                            <span class="idea_date">
                                                                2020-11-09 ~
                                                                    2020-12-31
                                                            </span>
                                                            <span class = "idea_like">❤️ 61</span>
                                                        </span>
