...
<fmt:formatNumber value="${vo.pro_now_amount }" pattern="0,000.00"/>    
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body>
			...
			<div class="fund_menu">
				...
				<div class="f_f_menu">
					<div id="sp_wrap">
						...
						<span id="now"><a href="End_main?pro_state=종료&pro_cate">종료</a></span>
					</div>
				</div>
			</div>
		</div>
		<div id="cate">
			<div id="cate_sec">
				<div id="cate_wrap">
					<ul class="cate_list">
						<li><a href = "?pro_state=종료&pro_cate">전체보기</a></li>
						<li><a href = "?pro_state=종료&pro_cate=테크/가전">테크·가전</a></li>
						<li><a href = "?pro_state=종료&pro_cate=패션/잡화">패션·잡화</a></li>
						<li><a href = "?pro_state=종료&pro_cate=뷰티">뷰티</a></li>
						<li><a href = "?pro_state=종료&pro_cate=푸드">푸드</a></li>
						<li><a href = "?pro_state=종료&pro_cate=홈리빙">홈리빙</a></li>
						<li><a href = "?pro_state=종료&pro_cate=반려동물">반려동물</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div id="all">
			<div class="all_product">
				...
				<%-- 	<li>
						<!-- 상품 상단 div -->
						<div id="li_t">
							<a href="../detail/detail_story"><img src="${pageContext.request.contextPath}/resources/img/product_investment/goods2.jpg"
								alt=""></a>
						</div> <!-- 상품 하단 div -->
						<div id="li_f">
							<!-- 상품 제목 div -->
							<div class="product_subject">
								<a href="../detail/detail_story"><p>서른가지 스톤을 셋팅 할 수 있는 팬던트
										"별을 따다줄게"</p></a>
							</div>
							<!-- 상품 내용 div -->
							<div class="product_content">
