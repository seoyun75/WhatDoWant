...
<%--                     <a href="detail_community?pro_state=${vo.provo.pro_state }&pro_cate=${vo.provo.pro_cate }&pro_code=${vo.provo.pro_code }">커뮤니티</a> --%>
            ...
            <div class="detail">
                <div class="out">
    				...
    				<c:forEach items = "${vo.probo }" var = "bobo">
                      <div>
                        <a href="detail_fd_process_view?pro_state=${vo.provo.pro_state}&pro_cate=${vo.provo.pro_cate }&pro_code=${vo.provo.pro_code }&project_board_no=${bobo.project_board_no}">
                            <p># 6</p>
                            <p>${bobo.project_board_title}</p>
                            <p>${bobo.project_board_regdate}</p>
                        </a>
                      </div>
                      </c:forEach>
                    </div>
